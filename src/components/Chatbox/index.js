...
import firebaseConfig from './firebaseconfig';// .gitignore already
  ...
  const items = [
    {
      ...
      label: (
        <button
          ...
          aria-label="Like"
          className={`p-2 rounded-full ${currentReaction === 'like' ? 'bg-lightblue border-2 border-blue-500' : 'bg-gray-100 border-0 hover:bg-gray-200'}`}
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          aria-label="Love"
          className={`p-2 rounded-full ${currentReaction === 'love' ? 'bg-lightblue border-2 border-pink-500' : 'bg-gray-100 border-0 hover:bg-gray-200'}`}
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          aria-label="Haha"
          className={`p-2 rounded-full ${currentReaction === 'haha' ? 'bg-lightblue border-2 border-yellow-500' : 'bg-gray-100 border-0 hover:bg-gray-200'}`}
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          aria-label="Wow"
          className={`p-2 rounded-full ${currentReaction === 'wow' ? 'bg-lightblue border-2 border-yellow-500' : 'bg-gray-100 border-0 hover:bg-gray-200'}`}
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          aria-label="Sad"
          className={`p-2 rounded-full ${currentReaction === 'sad' ? 'bg-lightblue border-2 border-yellow-500' : 'bg-gray-100 border-0 hover:bg-gray-200'}`}
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          aria-label="Angry"
          className={`p-2 rounded-full ${currentReaction === 'angry' ? 'bg-lightblue border-2 border-red-500' : 'bg-gray-100 border-0 hover:bg-gray-200'}`}
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          aria-label="Care"
          className={`p-2 rounded-full ${currentReaction === 'care' ? 'bg-lightblue border-2 border-green-500' : 'bg-gray-100 border-0 hover:bg-gray-200'}`}
        >
